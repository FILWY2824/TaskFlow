...
#
# 用法:
#   sudo ./restore.sh /opt/todoalarm/backup/todoalarm-20260428-030000.db.gz
...
systemctl start todoalarm
sleep 2
systemctl is-active --quiet todoalarm && echo "==> 服务已重启 ✓" || { echo "服务启动失败"; exit 3; }
