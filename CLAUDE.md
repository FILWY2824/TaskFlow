# TaskFlow — Claude Code 项目指南

> 多用户 TODO + Android / Windows 强提醒 + 全端管理系统
> 当前版本:**v0.5.0** (开发中)|规格文档 v2.2 已完成 12 个阶段
> 本文件是 Claude Code 启动时自动加载的项目记忆,**所有 subagent 都默认共享这里的内容**
...
本项目根据领域配置了若干 subagent(在 `.claude/agents/` 下)。Claude 应该按下面规则委派:
