...
<template>
  <div>
    ...
    <div v-if="ok" class="success-text" style="margin-bottom:10px;font-size:13px">{{ ok }}</div>

    <div class="section-card">
      <h3>当前绑定</h3>
      <div v-if="bindings.length === 0" class="muted" style="font-size:13px">尚未绑定 Telegram。绑定后，提醒到点会推送给你。</div>
    ...
    <div class="section-card">
      ...
      <p class="muted" style="color:var(--tg-warn)">
      ...
      <div v-if="tokenInfo" style="margin-top:14px">
        ...
        <div class="kv">
          ...
          <div class="v">{{ tokenInfo.deep_link_app }}</div>
